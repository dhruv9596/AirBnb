...
public class BookingServiceImpl implements BookingService{
    ...
    public HotelReportDto getHotelReport(Long hotelId, LocalDate startDate, LocalDate endDate) {
        ...
        log.info("Generateing Report for the hotel with Id : {} " + hotelId);
        ...
        BigDecimal avgRevenue =
                totalConfirmBookings == 0 ? BigDecimal.ZERO :
                totalRevenueOfConfirmedBookings.divide(BigDecimal.valueOf(totalConfirmBookings) , RoundingMode.HALF_UP);
